...
chatbot1 = ChatBot('Bakery Help',storage_adapter="chatterbot.storage.SQLStorageAdapter" ,logic_adapters=[
{
...
while True:
    try:
        ...
        if "bye" in str(input_statement):
            ...
            print("\U0001F9C1 Is there anything else I can help you with ? Enter bye to exit")
        else:
            response = chatbot1.generate_response(input_statement)
